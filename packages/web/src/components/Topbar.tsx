...
export default function Topbar() {
	...
	return (
		<header className="relative">
			<div className="w-full bg-black h-8 text-white text-end px-3 text-base items-center grid">
				Enterprise
			</div>
			<div className="w-full bg-white h-fit text-black px-3 text-base items-center flex space-x-4 relative">
				<img src="/logo192.png" className="h-8 my-3" />
